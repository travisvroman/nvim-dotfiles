...
--[[ if os == "linux" then
	dap.adapters.cppdbg = {
		id = "cppdbg",
		type = "executable",
		command = "/home/travis/nvim_dap/linux/extension/debugAdapters/bin/OpenDebugAD7",
	}
elseif os == "osx" then
	dap.adapters.cppdbg = {
		id = "cppdbg",
		type = "executable",
		command = "/home/travis/nvim_dap/osx/extension/debugAdapters/bin/OpenDebugAD7",
	}
elseif os == "windows" then
	dap.adapters.cppdbg = {
		id = "cppdbg",
		type = "executable",
		command = "C:\\Users\\travis\\nvim_dap\\win32\\extension\\debugAdapters\\bin\\OpenDebugAD7.exe",
		options = {
			detached = false,
		},
	}
...
dap.adapters.codelldb = {
	...
	port = "13000",
	executable = {
		command = "/home/travis/nvim_dap/linux/extension/adapter/codelldb", -- adjust as needed, must be absolute path,
		args = { "--port", "13000" },
